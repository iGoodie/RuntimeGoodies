package net.programmer.igoodie.goodies.query;

import net.programmer.igoodie.goodies.exception.GoodieSyntaxException;
import net.programmer.igoodie.goodies.query.accessor.ArrayIndexAccessor;
import net.programmer.igoodie.goodies.query.accessor.GoodieQueryAccessor;
import net.programmer.igoodie.goodies.query.accessor.ObjectFieldAccessor;
